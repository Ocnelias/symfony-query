...
final class Version20210323114041 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE query (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, date_time DATETIME, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
